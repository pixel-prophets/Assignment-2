...
var width = document.body.clientWidth,
  height = d3.max([document.body.clientHeight - 540, 360]);
...
var colors = {
  Africa: [0, 100, 54],
  "Asia Pacific": [122, 100, 54],
  CIS: [52, 100, 40],
  Europe: [177, 100, 15],
  "Middle East": [225, 100, 54],
  "North America": [293, 100, 54],
  "S. & Cent. America": [345, 100, 54],
};
...
function renderdata(raw_data) {
  currentyeardisplay.innerHTML = "Current year : " + currentyear;
...
d3.select("#toggle2021").on("click", ()=>{
  currentyear = "2021"
  d3.csv("2021.csv", renderdata)
});
d3.select("#toggle2015").on("click", ()=>{
  currentyear = "2015"
  d3.csv("2015.csv", renderdata)
});
d3.select("#toggle2005").on("click", ()=>{
  currentyear = "2005"
  d3.csv("2005.csv", renderdata)
});
d3.select("#toggle1995").on("click", ()=>{
  currentyear = "1995"
  d3.csv("1995.csv", renderdata)
});
d3.select("#toggle1985").on("click", ()=>{
  currentyear = "1985"
  d3.csv("1985.csv", renderdata)
});
d3.select("#toggle1975").on("click", ()=>{
  currentyear = "1975"
  d3.csv("1975.csv", renderdata)
});
d3.select("#toggle1965").on("click", ()=>{
  currentyear = "1965"
  d3.csv("1965.csv", renderdata)
});
